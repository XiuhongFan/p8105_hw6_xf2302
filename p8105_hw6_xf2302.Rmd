...
In contrast, the bootstrap distribution of the ratio $\hat{\beta}_{1}/\hat{\beta}_{2}$ is much wider and strongly left-skewed because the precipitation coefficient $\hat{\beta}_{2}$ is very small and varies near zero, making the ratio highly unstable under resampling.
...
Residuals are centered around zero with some mild curvature, suggesting minor nonlinear patterns not fully captured by the model.
