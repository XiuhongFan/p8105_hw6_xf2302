...
In contrast, the bootstrap distribution of the ratio β₁_hat / β₂_hat is
much wider and strongly left-skewed because the precipitation
coefficient $\hat{\beta}_{2}$ is very small and varies near zero, making
the ratio highly unstable under resampling.
