...
wider and strongly left-skewed because the precipitation coefficient
$\hat{\beta}_{2}$ is very small and varies near zero, making the ratio
highly unstable under resampling.
...
birth_plot_df %>%
  ...
  geom_smooth(se = FALSE, color = "skyblue", linewidth = 1.2) +
  labs(
